...
/**
 * Criteria class for the {@link com.blocknitive.com.domain.Celeb} entity. This class is used
 * in {@link com.blocknitive.com.web.rest.CelebResource} to receive all the possible filtering options from
...
public class CelebCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, celebName, appuserId, distinct);
    }
