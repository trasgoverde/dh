...
/**
 * Criteria class for the {@link com.blocknitive.com.domain.Appphoto} entity. This class is used
 * in {@link com.blocknitive.com.web.rest.AppphotoResource} to receive all the possible filtering options from
...
public class AppphotoCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, creationDate, appuserId, distinct);
    }
