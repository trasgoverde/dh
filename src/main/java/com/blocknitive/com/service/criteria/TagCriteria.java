...
/**
 * Criteria class for the {@link com.blocknitive.com.domain.Tag} entity. This class is used
 * in {@link com.blocknitive.com.web.rest.TagResource} to receive all the possible filtering options from
...
public class TagCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, tagName, postId, distinct);
    }
