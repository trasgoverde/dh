...
import com.blocknitive.com.service.CinterestQueryService;
...
/**
 * REST controller for managing {@link com.blocknitive.com.domain.Cinterest}.
 */
@RestController
@RequestMapping("/api")
public class CinterestResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/cinterests/{id}", consumes = { "application/json", "application/merge-patch+json" })
