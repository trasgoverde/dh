...
import com.blocknitive.com.service.FrontpageconfigQueryService;
import com.blocknitive.com.service.FrontpageconfigService;
import com.blocknitive.com.service.criteria.FrontpageconfigCriteria;
...
/**
 * REST controller for managing {@link com.blocknitive.com.domain.Frontpageconfig}.
 */
@RestController
@RequestMapping("/api")
public class FrontpageconfigResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/frontpageconfigs/{id}", consumes = { "application/json", "application/merge-patch+json" })
