...
import com.blocknitive.com.service.AppphotoQueryService;
...
/**
 * REST controller for managing {@link com.blocknitive.com.domain.Appphoto}.
 */
@RestController
@RequestMapping("/api")
public class AppphotoResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/appphotos/{id}", consumes = { "application/json", "application/merge-patch+json" })
