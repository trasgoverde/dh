...
import com.blocknitive.com.service.BlockuserQueryService;
...
/**
 * REST controller for managing {@link com.blocknitive.com.domain.Blockuser}.
 */
@RestController
@RequestMapping("/api")
public class BlockuserResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/blockusers/{id}", consumes = { "application/json", "application/merge-patch+json" })
