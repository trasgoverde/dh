...
import com.blocknitive.com.service.CelebQueryService;
...
/**
 * REST controller for managing {@link com.blocknitive.com.domain.Celeb}.
 */
@RestController
@RequestMapping("/api")
public class CelebResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/celebs/{id}", consumes = { "application/json", "application/merge-patch+json" })
