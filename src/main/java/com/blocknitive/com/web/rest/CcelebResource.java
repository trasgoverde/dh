...
import com.blocknitive.com.service.CcelebQueryService;
...
/**
 * REST controller for managing {@link com.blocknitive.com.domain.Cceleb}.
 */
@RestController
@RequestMapping("/api")
public class CcelebResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/ccelebs/{id}", consumes = { "application/json", "application/merge-patch+json" })
