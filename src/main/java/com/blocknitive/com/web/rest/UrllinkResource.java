...
import com.blocknitive.com.service.UrllinkQueryService;
import com.blocknitive.com.service.UrllinkService;
import com.blocknitive.com.service.criteria.UrllinkCriteria;
...
/**
 * REST controller for managing {@link com.blocknitive.com.domain.Urllink}.
 */
@RestController
@RequestMapping("/api")
public class UrllinkResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/urllinks/{id}", consumes = { "application/json", "application/merge-patch+json" })
