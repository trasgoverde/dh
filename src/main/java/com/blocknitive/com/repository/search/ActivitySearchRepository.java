...
class ActivitySearchRepositoryInternalImpl implements ActivitySearchRepositoryInternal {
    ...
    ActivitySearchRepositoryInternalImpl(ElasticsearchRestTemplate elasticsearchTemplate) {
    ...
    public Page<Activity> search(String query, Pageable pageable) {
        ...
        List<Activity> hits = elasticsearchTemplate
            .search(nativeSearchQuery, Activity.class)
