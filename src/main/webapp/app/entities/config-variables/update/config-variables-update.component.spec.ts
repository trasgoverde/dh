  ...
  describe('ConfigVariables Management Update Component', () => {
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', () => {
        // GIVEN
        const saveSubject = new Subject<HttpResponse<ConfigVariables>>();
        const configVariables = { id: 123 };
        jest.spyOn(configVariablesService, 'update').mockReturnValue(saveSubject);
      ...
      it('Should call create service on save for new entity', () => {
        ...
        jest.spyOn(configVariablesService, 'create').mockReturnValue(saveSubject);
        jest.spyOn(comp, 'previousState');
        activatedRoute.data = of({ configVariables });
        comp.ngOnInit();
