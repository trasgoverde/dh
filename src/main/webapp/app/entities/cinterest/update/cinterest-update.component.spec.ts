  ...
  describe('Cinterest Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Community query and add missing value', () => {
        ...
        const communities: ICommunity[] = [{ id: 48258 }];
        cinterest.communities = communities;

        const communityCollection: ICommunity[] = [{ id: 40376 }];
      ...
      it('Should update editForm', () => {
        const cinterest: ICinterest = { id: 456 };
        const communities: ICommunity = { id: 45199 };
        cinterest.communities = [communities];
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', () => {
        // GIVEN
        const saveSubject = new Subject<HttpResponse<Cinterest>>();
        const cinterest = { id: 123 };
        jest.spyOn(cinterestService, 'update').mockReturnValue(saveSubject);
      ...
      it('Should call create service on save for new entity', () => {
        ...
        jest.spyOn(cinterestService, 'create').mockReturnValue(saveSubject);
        jest.spyOn(comp, 'previousState');
        activatedRoute.data = of({ cinterest });
        comp.ngOnInit();
