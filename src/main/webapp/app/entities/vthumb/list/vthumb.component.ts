...
export class VthumbComponent implements OnInit {
  vthumbs?: IVthumb[];
  ...
  protected onSuccess(data: IVthumb[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
