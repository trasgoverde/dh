    ...
    describe('Service methods', () => {
      ...
      describe('addAppphotoToCollectionIfMissing', () => {
        ...
        it('should add only unique Appphoto to an array', () => {
          const appphotoArray: IAppphoto[] = [{ id: 123 }, { id: 456 }, { id: 40535 }];
        ...
        it('should return initial array if no Appphoto is added', () => {
          const appphotoCollection: IAppphoto[] = [{ id: 123 }];
          expectedResult = service.addAppphotoToCollectionIfMissing(appphotoCollection, undefined, null);
          expect(expectedResult).toEqual(appphotoCollection);
        });
      });
    });
