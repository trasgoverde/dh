  ...
  describe('Appphoto Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call appuser query and add missing value', () => {
        ...
        const appuser: IAppuser = { id: 39537 };
        appphoto.appuser = appuser;

        const appuserCollection: IAppuser[] = [{ id: 86247 }];
      ...
      it('Should update editForm', () => {
        const appphoto: IAppphoto = { id: 456 };
        const appuser: IAppuser = { id: 77017 };
        appphoto.appuser = appuser;
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', () => {
        // GIVEN
        const saveSubject = new Subject<HttpResponse<Appphoto>>();
        const appphoto = { id: 123 };
        jest.spyOn(appphotoService, 'update').mockReturnValue(saveSubject);
      ...
      it('Should call create service on save for new entity', () => {
        ...
        jest.spyOn(appphotoService, 'create').mockReturnValue(saveSubject);
        jest.spyOn(comp, 'previousState');
        activatedRoute.data = of({ appphoto });
        comp.ngOnInit();
