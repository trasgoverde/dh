...
export class VquestionComponent implements OnInit {
  ...
  search(query: string): void {
    if (query && ['vquestion', 'vquestionDescription'].includes(this.predicate)) {
      this.predicate = 'id';
      this.ascending = true;
    }
  ...
  protected onSuccess(data: IVquestion[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
