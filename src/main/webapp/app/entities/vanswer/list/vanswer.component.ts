...
export class VanswerComponent implements OnInit {
  vanswers?: IVanswer[];
  ...
  search(query: string): void {
    if (query && ['urlVanswer'].includes(this.predicate)) {
      this.predicate = 'id';
      this.ascending = true;
    }
  ...
  protected onSuccess(data: IVanswer[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
