  ...
  describe('Frontpageconfig Management Update Component', () => {
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', () => {
        // GIVEN
        const saveSubject = new Subject<HttpResponse<Frontpageconfig>>();
        const frontpageconfig = { id: 123 };
        jest.spyOn(frontpageconfigService, 'update').mockReturnValue(saveSubject);
      ...
      it('Should call create service on save for new entity', () => {
        ...
        jest.spyOn(frontpageconfigService, 'create').mockReturnValue(saveSubject);
        jest.spyOn(comp, 'previousState');
        activatedRoute.data = of({ frontpageconfig });
        comp.ngOnInit();
