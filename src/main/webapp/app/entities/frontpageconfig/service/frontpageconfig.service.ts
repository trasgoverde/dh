...
export class FrontpageconfigService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/frontpageconfigs');
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/_search/frontpageconfigs');
