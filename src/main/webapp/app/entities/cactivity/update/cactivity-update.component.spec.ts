  ...
  describe('Cactivity Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Community query and add missing value', () => {
        ...
        const communities: ICommunity[] = [{ id: 80843 }];
        cactivity.communities = communities;

        const communityCollection: ICommunity[] = [{ id: 9403 }];
      ...
      it('Should update editForm', () => {
        const cactivity: ICactivity = { id: 456 };
        const communities: ICommunity = { id: 68878 };
        cactivity.communities = [communities];
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', () => {
        // GIVEN
        const saveSubject = new Subject<HttpResponse<Cactivity>>();
        const cactivity = { id: 123 };
        jest.spyOn(cactivityService, 'update').mockReturnValue(saveSubject);
      ...
      it('Should call create service on save for new entity', () => {
        ...
        jest.spyOn(cactivityService, 'create').mockReturnValue(saveSubject);
        jest.spyOn(comp, 'previousState');
        activatedRoute.data = of({ cactivity });
        comp.ngOnInit();
