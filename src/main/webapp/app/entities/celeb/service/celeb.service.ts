...
export class CelebService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/celebs');
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/_search/celebs');
  ...
  search(req: SearchWithPagination): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<ICeleb[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
