  ...
  describe('Celeb Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Appuser query and add missing value', () => {
        ...
        const appusers: IAppuser[] = [{ id: 48388 }];
        celeb.appusers = appusers;

        const appuserCollection: IAppuser[] = [{ id: 9266 }];
      ...
      it('Should update editForm', () => {
        const celeb: ICeleb = { id: 456 };
        const appusers: IAppuser = { id: 80915 };
        celeb.appusers = [appusers];
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', () => {
        // GIVEN
        const saveSubject = new Subject<HttpResponse<Celeb>>();
        const celeb = { id: 123 };
        jest.spyOn(celebService, 'update').mockReturnValue(saveSubject);
      ...
      it('Should call create service on save for new entity', () => {
        ...
        jest.spyOn(celebService, 'create').mockReturnValue(saveSubject);
        jest.spyOn(comp, 'previousState');
        activatedRoute.data = of({ celeb });
        comp.ngOnInit();
