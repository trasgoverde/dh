  ...
  describe('Cceleb Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Community query and add missing value', () => {
        ...
        const communities: ICommunity[] = [{ id: 60729 }];
        cceleb.communities = communities;

        const communityCollection: ICommunity[] = [{ id: 66323 }];
      ...
      it('Should update editForm', () => {
        const cceleb: ICceleb = { id: 456 };
        const communities: ICommunity = { id: 13419 };
        cceleb.communities = [communities];
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', () => {
        // GIVEN
        const saveSubject = new Subject<HttpResponse<Cceleb>>();
        const cceleb = { id: 123 };
        jest.spyOn(ccelebService, 'update').mockReturnValue(saveSubject);
      ...
      it('Should call create service on save for new entity', () => {
        ...
        jest.spyOn(ccelebService, 'create').mockReturnValue(saveSubject);
        jest.spyOn(comp, 'previousState');
        activatedRoute.data = of({ cceleb });
        comp.ngOnInit();
