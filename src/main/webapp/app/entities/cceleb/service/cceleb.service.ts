...
export class CcelebService {
  protected resourceUrl = this.applicationConfigService.getEndpointFor('api/ccelebs');
  protected resourceSearchUrl = this.applicationConfigService.getEndpointFor('api/_search/ccelebs');
