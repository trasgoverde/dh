...
export class ProposalComponent implements OnInit {
  ...
  search(query: string): void {
    if (query && ['proposalName', 'proposalType', 'proposalRole'].includes(this.predicate)) {
      this.predicate = 'id';
      this.ascending = true;
    }
  ...
  protected onSuccess(data: IProposal[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
