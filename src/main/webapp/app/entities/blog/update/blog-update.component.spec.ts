  ...
  describe('Blog Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Appuser query and add missing value', () => {
        ...
        const appuser: IAppuser = { id: 37136 };
        blog.appuser = appuser;

        const appuserCollection: IAppuser[] = [{ id: 64085 }];
      ...
      it('Should call Community query and add missing value', () => {
        const blog: IBlog = { id: 456 };
        const community: ICommunity = { id: 8682 };
        blog.community = community;

        const communityCollection: ICommunity[] = [{ id: 26302 }];
      ...
      it('Should update editForm', () => {
        const blog: IBlog = { id: 456 };
        const appuser: IAppuser = { id: 66093 };
        blog.appuser = appuser;
        const community: ICommunity = { id: 10370 };
        blog.community = community;
