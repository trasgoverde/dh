...
import com.blocknitive.com.service.criteria.FeedbackCriteria;
...
class FeedbackResourceIT {
     ...
     *
     * @see com.blocknitive.com.repository.search.FeedbackSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void searchFeedback() throws Exception {
        ...
        // Initialize the database
        feedbackRepository.saveAndFlush(feedback);
        when(mockFeedbackSearchRepository.search("id:" + feedback.getId(), PageRequest.of(0, 20)))
