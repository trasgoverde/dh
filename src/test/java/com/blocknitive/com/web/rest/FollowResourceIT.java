...
import com.blocknitive.com.service.criteria.FollowCriteria;
...
class FollowResourceIT {
     ...
     *
     * @see com.blocknitive.com.repository.search.FollowSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void searchFollow() throws Exception {
        ...
        // Initialize the database
        followRepository.saveAndFlush(follow);
        when(mockFollowSearchRepository.search("id:" + follow.getId(), PageRequest.of(0, 20)))
