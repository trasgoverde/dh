...
class UrllinkResourceIT {
     ...
     *
     * @see com.blocknitive.com.repository.search.UrllinkSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void searchUrllink() throws Exception {
        ...
        // Initialize the database
        urllinkRepository.saveAndFlush(urllink);
        when(mockUrllinkSearchRepository.search("id:" + urllink.getId(), PageRequest.of(0, 20)))
