...
class ConfigVariablesResourceIT {
     ...
     *
     * @see com.blocknitive.com.repository.search.ConfigVariablesSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void searchConfigVariables() throws Exception {
        ...
        // Initialize the database
        configVariablesRepository.saveAndFlush(configVariables);
        when(mockConfigVariablesSearchRepository.search("id:" + configVariables.getId(), PageRequest.of(0, 20)))
