...
class CinterestResourceIT {
     ...
     *
     * @see com.blocknitive.com.repository.search.CinterestSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void searchCinterest() throws Exception {
        ...
        // Initialize the database
        cinterestRepository.saveAndFlush(cinterest);
        when(mockCinterestSearchRepository.search("id:" + cinterest.getId(), PageRequest.of(0, 20)))
