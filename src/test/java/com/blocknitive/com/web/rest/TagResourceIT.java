...
import com.blocknitive.com.service.criteria.TagCriteria;
...
class TagResourceIT {
     ...
     *
     * @see com.blocknitive.com.repository.search.TagSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void searchTag() throws Exception {
        ...
        // Initialize the database
        tagRepository.saveAndFlush(tag);
        when(mockTagSearchRepository.search("id:" + tag.getId(), PageRequest.of(0, 20)))
