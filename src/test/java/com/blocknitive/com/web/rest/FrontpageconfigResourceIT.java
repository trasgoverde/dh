...
class FrontpageconfigResourceIT {
     ...
     *
     * @see com.blocknitive.com.repository.search.FrontpageconfigSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void searchFrontpageconfig() throws Exception {
        ...
        // Initialize the database
        frontpageconfigRepository.saveAndFlush(frontpageconfig);
        when(mockFrontpageconfigSearchRepository.search("id:" + frontpageconfig.getId(), PageRequest.of(0, 20)))
