...
import com.blocknitive.com.service.criteria.ActivityCriteria;
...
class ActivityResourceIT {
     ...
     *
     * @see com.blocknitive.com.repository.search.ActivitySearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void searchActivity() throws Exception {
        ...
        // Initialize the database
        activityRepository.saveAndFlush(activity);
        when(mockActivitySearchRepository.search("id:" + activity.getId(), PageRequest.of(0, 20)))
