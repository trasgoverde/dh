...
import com.blocknitive.com.service.criteria.PostCriteria;
...
class PostResourceIT {
     ...
     *
     * @see com.blocknitive.com.repository.search.PostSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    @Test
    @Transactional
    void getAllPostsByProposalIsEqualToSomething() throws Exception {
        // Initialize the database
        postRepository.saveAndFlush(post);
        Proposal proposal;
