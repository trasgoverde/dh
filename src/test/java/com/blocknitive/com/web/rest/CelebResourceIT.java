...
class CelebResourceIT {
     ...
     *
     * @see com.blocknitive.com.repository.search.CelebSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void searchCeleb() throws Exception {
        ...
        // Initialize the database
        celebRepository.saveAndFlush(celeb);
        when(mockCelebSearchRepository.search("id:" + celeb.getId(), PageRequest.of(0, 20)))
